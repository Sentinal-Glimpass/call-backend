...
const superadminTelephonyRouter = require('./src/routes/superadminTelephonyRouter');
...
app.use('/superadmin/telephony', superadminTelephonyRouter); // Superadmin telephony management (Super Key auth)
